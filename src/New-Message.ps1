...
PS > New-Message 'MyMessage';
AutoGeneratedMessageId 		# like e6dc938213264de790e53ace7949f610

.EXAMPLE
Similar to the previous example, but set the message ttl to 60 seconds (overrides the default ttl which is defined on the Facility description).

PS > New-Message 'Unimportant' -TimeToLiveSec 60;
AutoGeneratedMessageId 		# like e6dc938213264de790e53ace7949f610

.EXAMPLE
Similar to the previous example, but adds further properties and sets the message id and label.

PS > New-Message 'MyMessage' -Properties @{'Prop1'='Valu1';'Prop2'='Valu2'} -Label 'OrderEngine1' -Id 'MyMessageId1';
MyMessageId1

.EXAMPLE
An example showing how to use the cmdlet in a pipeline

PS > [array]$messageid = @('Message1', 'Message2') | New-Message;
PS > $messageid
AutoGeneratedMessageId1
AutoGeneratedMessageId2
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUdSnPY/euTmEzvECCd1/fXllk
# guKgghHCMIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQMqsQRMkX5xOrd
# YobR318INDB6czANBgkqhkiG9w0BAQEFAASCAQCScoFqsCLskNY119jO0lWhwhkG
# Tm/Sc3IeY7/ExZ/D2/w7rEK0iRE8Wnt3KNtYSW1Mg+B+i8hpaRQS42ebR2f8FvL+
# fegicQQq0GDZ3GVHZnJofiqU2YcFfOrhIcKkpzgzwS+9nwmGEvdoO+DAXXIlNtRY
# KOzN4U8kDmCDJ/dH2kFbVBkE/i7ZG3A706sww2pYpC1IeAGugFGsBdszf5ciBbSf
# 76g7zRGMuUH9yDNvj7vsI9xMsM3S6gDqrGG1h02ijSNmVCFMtlGn3LpNj43E4NiQ
# zrqLkVFhvZUzvXbk7lC2OZ0ELfUmQJVP5b1KJ+2u/29IPevVjFMoeLTz7M4eoYIC
# ojCCAp4GCSqGSIb3DQEJBjGCAo8wggKLAgEBMGgwUjELMAkGA1UEBhMCQkUxGTAX
# BgNVBAoTEEdsb2JhbFNpZ24gbnYtc2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGlt
# ZXN0YW1waW5nIENBIC0gRzICEhEhBqCB0z/YeuWCTMFrUglOAzAJBgUrDgMCGgUA
# oIH9MBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE1
# MTIxNTE2NTE0M1owIwYJKoZIhvcNAQkEMRYEFPgCr1DH0THQ4vmP1Dg3q3+rKHxs
# MIGdBgsqhkiG9w0BCRACDDGBjTCBijCBhzCBhAQUs2MItNTN7U/PvWa5Vfrjv7Es
# KeYwbDBWpFQwUjELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYt
# c2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gRzICEhEh
# BqCB0z/YeuWCTMFrUglOAzANBgkqhkiG9w0BAQEFAASCAQCgIT/X6ZvPR1KhcYl3
# f/s4w4ky8ttIhobhVrZ5/NyOx2c8MjBH6SUcrnh41Qt91cYBt8cKGvSEWJFcT0xX
# lCgx5aF41/lmyO+4dRipZvQe+QrZypiy7StbOungmRuECEZphfgTaThqdb8fQcMn
# fd2GMAEKrG7w1rDI3py4bvH99QpdpYjp9MeZaDwOEdd50DduJd5pn/T2JV+rtzN3
# TBRuQUps1EoYy/yPZcnoj/IfeO+rIy7/NsLpLNzzQc+uGj0zew6UlNzUoWS/bLN4
# cA1UqQmD7UO8OMBETKy5raDladKD8Ksmdra2xYlLtj25gaQqk6WZuF+01jwCegv/
# l8fL
